 ...
 * T035: Login page.
 *
 * Spec Reference: AR-001 - Better Auth integration
 */
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                disabled={isLoading}
                className="mt-1 block w-full px-4 py-3 border border-gray-300 rounded-lg shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 disabled:bg-gray-100"
